...
%DIF DEL /tmp/iLUqyXUJ8E/latexdiff-vc-HEAD~1/thesis.tex   Thu Dec  3 09:38:01 2020
%DIF ADD thesis.tex                                       Thu Dec  3 09:39:49 2020
  sotsuron]{kuee}
...
\DIFdelbegin \DIFdel{これはdiffのexampleのための文章です。 scripts/generate-diff.sh
thesis.tex を実行することで、diffが視覚的に分かるpdfを作成できます。
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \cite{GuideBook}
...
\DIFadd{masterにマージすることで、マージ前との差分が可視化されたpdfがdiffディレクトリ内に作成されます。
}\DIFaddend 
