...
%DIF DEL /tmp/uGyKiD4UWI/latexdiff-vc-HEAD~1/thesis.tex   Thu Dec  3 08:39:52 2020
%DIF ADD thesis.tex                                       Thu Dec  3 08:46:31 2020
  sotsuron]{kuee}
...
\DIFaddbegin \DIFadd{これはdiffのexampleのための文章です。 scripts/generate-diff.sh
thesis.tex を実行することで、diffが視覚的に分かるpdfを作成できます。
}

\DIFaddend \cite{GuideBook}

adfa (晴彦 and 裕介 2017, pp)
\DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{あいうえお}\footnote{\DIFdel{あいうえおあ}}
%DIFAUXCMD
